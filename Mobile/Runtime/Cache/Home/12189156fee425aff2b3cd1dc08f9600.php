...
<script language="javascript" src="/free/Public/mobile/js/pcasunzip.js" charset="gb2312"></script>
...
<form action="/free/mobile.php/home/info/detail" method="post" enctype="multipart/form-data" onSubmit="return login();" id="loginForm">


<div class="xm">
  <ul class="xin">
    <li class="z1">姓名：</li>
    <li class="z2" ><input type="text" placeholder="请填写身份证上的姓名"  name="yonghuming" id="yonghuming"/ value="<?php echo ($user_data["u_name"]); ?>" <?php if($loan_data['is_loan'] == 1 OR $loan_data['loan_num'] >= 1 OR $user_data['identity'] != ''): ?>readonly="readonly"<?php else: endif; ?>/></li>
  </ul>
</div>
...
<div class="sfz">
  <ul class="xin">
    <li class="z1">身份证号：</li>
    <li class="z2">
      <input type="text" placeholder="请填写正确的身份证号码"  name="shenfenzheng" id="shenfenzheng" value="<?php echo ($user_data["identity"]); ?>" <?php if($loan_data['is_loan'] == 1 OR $loan_data['loan_num'] >= 1 OR $user_data['identity'] != ''): ?>readonly="readonly"<?php else: endif; ?>/></li>
  </ul>
</div>
  ...
  <ul class="xin">
    ...
    <li class="z2">
      <select  id="select_k1" class="xla_k" name="xueli">
        <option value="中专" <?php if($data["education"] == '中专'): ?>selected = "selected"<?php else: endif; ?>>中专及以下</option>
        <option value="大专" <?php if($data["education"] == '大专'): ?>selected = "selected"<?php else: endif; ?>>大专</option>
        <option value="本科" <?php if($data["education"] == '本科'): ?>selected = "selected"<?php else: endif; ?>>本科</option>
        <option value="研究生" <?php if($data["education"] == '研究生'): ?>selected = "selected"<?php else: endif; ?>>研究生</option>
        <option value="博士" <?php if($data["education"] == '博士'): ?>selected = "selected"<?php else: endif; ?>>博士</option>
      </select>
    </li>
  </ul>
</div>   -->
...
new PCAS("user.province","user.city","user.area","<?php echo ($addres[0]); ?>","<?php echo ($addres[1]); ?>","<?php echo ($addres[2]); ?>");
</script>
...
<div class="sfz" style=" border-top:1px solid #ccc;">
  <ul class="xin">
    <li class="z1">详细地址：</li>
    <li class="z2">
      <input type="text"  name="addres" id="addres" value="<?php echo ($addres[3]); ?>" <?php if($loan_data["is_loan"] == 1): ?>readonly="readonly"<?php else: endif; ?> /></li>
  </ul>
</div>
...
<script language="javascript" defer>
new PCAS("company.province","company.city","company.area","<?php echo ($com_addres[0]); ?>","<?php echo ($com_addres[1]); ?>","<?php echo ($com_addres[2]); ?>");
</script>
...
<div class="sfz" style=" border-top:1px solid #ccc;">
  <ul class="xin">
    <li class="z1">详细地址：</li>
    <li class="z2">
      <input type="text" name="com_addres" id="com_addres" value="<?php echo ($com_addres[3]); ?>" <?php if($loan_data["is_loan"] == 1): ?>readonly="readonly"<?php else: endif; ?> /></li>
  </ul>
</div>
<!-- 地址 -->
