...
class LLpay_submit {
	 ...
	 *
	 */
	// var $llpay_gateway_new = 'https://repaymentapi.lianlianpay.com/bankcardrepayment.htm';

	function __construct($llpay_config,$llpay_gateway_new) {
		$this->llpay_config = $llpay_config;
		$this->llpay_gateway_new = $llpay_gateway_new;
	}
	function LLpay_submit($llpay_config) {
