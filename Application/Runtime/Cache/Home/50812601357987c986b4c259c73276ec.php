               ...
               <div class="col-sm-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>通过支付宝还款:<span style="color: red"><?php echo ($count); ?></span>笔</h5>
                            <h5 style="margin-left:50px;">放款金额总和:<span style="color: red;"><?php echo ($pay_money); ?></span>元</h5>
                            <h5 style="margin-left:50px;">还款金额总和:<span style="color: red;"><?php echo ($repayment_money); ?></span>元</h5>
                            <h5 style="margin-left:50px;">综合费用总和:<span style="color: red;"><?php echo ($repayment_money-$pay_money); ?></span>元</h5>
                            <h5 style="margin-left:50px;">逾期费用总和:<span style="color: red;"><?php echo ($over_charges); ?></span>元</h5>
                            <h5 style="margin-left:50px;">免逾期费用总和:<span style="color: red;"><?php echo ($payment); ?></span>元</h5>
                            <h5 style="margin-left:50px;">提前还款人数:<span style="color: red;"><?php echo ($people); ?></span>人</h5>
                            <h5 style="margin-left:50px;">提前还款金额:<span style="color: red;"><?php echo ($peopleMoney); ?></span>元</h5>
                        </div>
                        <div class="ibox-title">  
                            <form action="<?php echo U('Home/repayment/search',array('id'=>'0'));?>" method="post" style="float: left; margin-right: 60px;" >
                            ...
                            <form action="<?php echo U('Home/repayment/ll_search1',array('id'=>'0'));?>" method="post" style="float: left; margin-right: 60px;" >
                                <input placeholder="开始时间" required type="text" id="layui-laydate-input" onclick="layui.laydate({elem: this})" class="layui-input" name="start1">
                                <input placeholder="结束时间" required type="text" id="layui-laydate-input" onclick="layui.laydate({elem: this})" class="layui-input" name="end1">
                                <input type="hidden" name="code" value="1">
                            ...
                            <a style="float:right; margin-right: 50px;" href="<?php echo U('Home/repayment/export');?>"><button>导出</button></a>
                            <a style="float:right; margin-right: 50px;" href="<?php echo U('Home/repayment/remarks');?>"><button>备注</button></a>
                            ...
                            <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="8">
                                ...
                                <tbody>
                                    <?php if(is_array($info)): $k = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                                            <td><?php echo ($k); ?></td>
                                            <td>
                                                <a href="/free/index.php/Home/repayment/alters?record_id=<?php echo ($vo['record_id']); ?>">
                                            ...
                                            <td><?php echo ($vo['pay_money']); ?>元</td>
                                            <td><?php echo ($vo['repayment_money']-$vo['pay_money']); ?>元</td>
