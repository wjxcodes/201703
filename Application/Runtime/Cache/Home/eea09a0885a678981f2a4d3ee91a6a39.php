    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <a href="/free/index.php/Home/Mention/add"><button>新增方案</button></a>
                <table id="mytable" class="footable table table-stripped toggle-arrow-tiny" data-page-size="8">
                    ...
                    <?php if(is_array($mention_data)): $i = 0; $__LIST__ = $mention_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            <td><?php echo ($vo['now_money']); ?></td>
                            <td><?php echo ($vo['sum_money']); ?></td>
                            <td><?php echo (date("Y-m-d H:i:s",$vo['create_time'])); ?></td>
                            <td><?php echo ($vo['create_per']); ?></td>
                            <td>
                                <?php if($vo['is_use'] == 1): ?>失效
                                <?php else: ?>
                                    生效中<?php endif; ?>
                            </td>
                            <td><a href="/free/index.php/Home/Mention/coupons?id=<?php echo ($vo['id']); ?>"><button>详情</button></a></td>
                            <td><a href="/free/index.php/Home/Mention/delete?id=<?php echo ($vo['id']); ?>"><button>移除</button></a></td>
