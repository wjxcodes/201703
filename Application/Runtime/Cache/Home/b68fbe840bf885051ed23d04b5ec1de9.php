        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-title">
                  ...
                  <a style="float:right; margin-left: 30%;" href="<?php echo U('Home/Overdue/five_day');?>"><button>五天短信模板</button></a>
                  <a style="float:right;" href="<?php echo U('Home/Overdue/send_note');?>"><button>五天之后短信模板</button></a>
                </div>
                </form>
                        <div class="ibox-title">  
                            <form action="<?php echo U('Home/Overdue/index');?>" method="post" >
                            ...
                            <a style="float:right;" href="<?php echo U('Home/Overdue/export_pre');?>"><button>导出</button></a>
                <div class="ibox-content">
                    ...
                    <table id="mytable" class="footable table table-stripped toggle-arrow-tiny" data-page-size="8">
                        ...
                        <?php if(is_array($arr)): $k = 0; $__LIST__ = $arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                                        ...
                                        <td>
                                            <?php if(($vo['query_message'] == 1)): ?>已发
                                            <?php else: ?>
                                            未发<?php endif; ?>
                                        </td>
                                       <td>
                                        <?php if($vo['open_id'] == '' ): else: ?>
                                            <a href="/free/index.php/Home/message/index?open_id=<?php echo ($vo['open_id']); ?>&user_name=<?php echo ($vo['user_name']); ?>">发送</a><?php endif; ?>
                                        </td>
