            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <table id="mytable" class="footable table table-stripped toggle-arrow-tiny" data-page-size="8">
                        ...
                        <tbody>
                        <?php if(is_array($lstdata)): $k = 0; $__LIST__ = $lstdata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                                        <td><a href="<?php echo U('Home/Infoaudit/photo',array('id'=>$vo['user_name'],'open_id'=>$vo['open_id']));?>"><?php echo ($k); ?></a></td>
                                        <td><a href="<?php echo U('Home/Examine/sendWx',array('id'=>$vo['user_name'],'open_id'=>$vo['open_id']));?>"><button>微信通知</button></a></td>
                                        <td><?php echo ($vo['user_name']); ?></td>
                                        <td><a href="<?php echo U('Home/taobao/info',array('tel'=>$vo['user_name']));?>"><?php echo ($vo['bank_name']); ?></a></td>
                                        <td><a href="<?php echo U('Home/Survey/index',array('id'=>$vo['user_name'],'open_id'=>$vo['open_id']));?>"><?php echo ($vo['identity']); ?></a></td>
                                        <td><?php echo ($vo['bank_card']); ?></td>
                                        <td><?php echo ($vo['loan_order']); ?></td>
                                       
                                         <td><b><?php echo ($vo['loan_amount']); ?>元</b></td>
                                        <td>
                                        <?php if(($vo['loan_time'] == 1)): ?><b>7天</b>
                                        <?php elseif(($vo['loan_time'] == 2)): ?>
                                            <b>14天</b><?php endif; ?>
                                        </td>
                                         <td>
                                            <?php echo ($vo['loan_amount']*$vo['interest']-$vo['cuts_interest']); ?>元
                                        </td>
                                        <td><?php echo ($vo['loan_num']); ?></td>
                                        
                                        <td><?php echo (date("Y-m-d H:i",$vo['loan_request'])); ?></td>
                                        <td>
                                            <?php if(($vo['check'] == 0)): ?><a href="<?php echo U('Home/Examine/checkUser',array('id'=>$vo['user_id']));?>"><button style="color:red;border:1px solid #ccc;">未核实</button></a>
                                            <?php else: ?>
                                                <a href="<?php echo U('Home/Examine/checkUser',array('id'=>$vo['user_id']));?>"><button style="color:green;border:1px solid #ccc;">已核实</button></a><?php endif; ?>
                                        </td>
                                        <td>
                                            <a href="<?php echo U('Home/Examine/change',array('id'=>$vo['user_id'],'status'=>2));?>">通过</a> | <a href="<?php echo U('Home/Examine/change',array('id'=>$vo['user_id'],'status'=>1,'m'=>$vo['
                                            ']));?>">不通过</a>
                                        </td>
