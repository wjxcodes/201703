               ...
               <div class="col-sm-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <?php if($stages_data[0] != ''): ?><table class="footable table table-stripped toggle-arrow-tiny" data-page-size="8">
                                    <tr>
                                        <td>还款金额</td>
                                        <td>支付宝单号</td>
                                        <td>创建人</td>
                                    ...
                                    <?php if(is_array($stages_data)): $i = 0; $__LIST__ = $stages_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                            <td><?php echo ($vo['money']); ?></td>
                                            <td><?php echo ($vo['zfb_order']); ?></td>
                                            <td><?php echo ($vo['create_per']); ?></td>
                                            <td><?php echo (date("Y-m-d",$vo['create_time'])); ?></td>
                                        </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                                </table><?php endif; ?>

                            <form class="form-horizontal m-t" id="commentForm" action="<?php echo U('Home/Already/stages',array('order'=>$order));?>" method="post">
                                <div class="form-group">
                                    <label class="col-sm-1 control-label">支付宝单号：</label>
                                    <div class="col-sm-2">
                                        <input id="cname" name="zfb_order" minlength="2" type="text" class="form-control" required="" aria-required="true">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-1 control-label">还款金额：</label>
                                    <div class="col-sm-2">
                                        <input id="cname" name="money" minlength="2" type="text" class="form-control" required="" aria-required="true">
                                    </div>
                                </div>
                                <div class="form-group">
