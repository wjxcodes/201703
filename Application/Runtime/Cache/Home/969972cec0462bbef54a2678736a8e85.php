               ...
               <div class="col-sm-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>总提额:<span style='color: red'></span><?php echo ($money); ?>元<?php echo ($money/100); ?>人</h5>

                            <h5>当天提额:<span style='color: red'></span><?php echo ($day_money); ?>元<?php echo ($day_i); ?>人</h5>
                        </div>
                            <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="8">
                                ...
                                <?php if(is_array($lines_data)): $i = 0; $__LIST__ = $lines_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                        <td><?php echo ($vo['手机号']); ?></td>
                                        <td><?php echo ($vo['提升额度']); ?></td>
                                        <td><?php echo ($vo['提升前']); ?></td>
                                        <td><?php echo ($vo['提升时间']); ?></td>
                                    </tr><?php endforeach; endif; else: echo "" ;endif; ?>
                            </table>
                            
                            <?php if(is_array($time_data)): $i = 0; $__LIST__ = $time_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="/free/index.php/Home/Already/look?time=<?php echo ($vo); ?>"><button ><?php echo ($key); ?></button></a><?php endforeach; endif; else: echo "" ;endif; ?>
                        </div>
                    </div>
                </div>
        </div>
