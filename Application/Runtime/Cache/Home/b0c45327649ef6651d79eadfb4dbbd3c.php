        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>预催收列表</h5>
                     <h5 style="margin-left:50px;">预催收人数:<span style="color: red"><?php echo ($pre_sum); ?></span>人</h5>
                </div>
                <div class="ibox-title">
                    <a style="margin-left:10%;" href="<?php echo U('Home/Pre/note_template',array('code'=>'1'));?>"><button>预催收短信模板</button></a>
                    <a style="margin-left:10%;" href="<?php echo U('Home/Pre/export_pre');?>"><button>导出预催收名单</button></a>
                    <a style="margin-left:10%;" href="<?php echo U('Home/Overdue/precollection');?>"><button>发送预催收短信</button></a>
                    <a style="margin-left:10%;" href="<?php echo U('Home/Overdue/precoll');?>"><button>发送预催收微信</button></a>
                </div>
                <div class="ibox-content">
                    <table id="mytable" class="footable table table-stripped toggle-arrow-tiny" data-page-size="8">
                        ...
                        <?php if(is_array($arr)): $k = 0; $__LIST__ = $arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                                        <td><?php echo ($k); ?></td>
                                        <td>
                                            <a href="/free/index.php/Home/Pre/credit?id=<?php echo ($vo['user_name']); ?>&open_id=<?php echo ($vo['open_id']); ?>"><?php echo ($vo['user_name']); ?></a>
                                        </td>
