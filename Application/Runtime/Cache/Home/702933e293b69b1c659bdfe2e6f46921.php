...
<body class="fixed-sidebar full-height-layout gray-bg" style="overflow:hidden">
  ...
  <!--右侧部分开始-->
        <div id="page-wrapper" class="gray-bg dashbard-1">
           <form action="/free/index.php/Home/Repayment/alters?record_id=<?php echo $_GET['record_id'] ?>" method="post" enctype="multipart/form-data">
          <input type="text" name="paytime" placeholder="还款时间">
          <input type="text" name="paymoney" placeholder="免去的逾期费用">
           <br/>
