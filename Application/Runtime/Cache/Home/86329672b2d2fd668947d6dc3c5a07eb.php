                    ...
                    <div class="ibox float-e-margins">
                        <div class="ibox-title" id="sumtext">
                           ...
                           <!--  <h5 style='margin-left:50px;'>到期应还总和:<span style='color: red;'></span><?php echo ($sum['shouxufei']+$sum['sum_money']); ?>元</h5> -->
                            <?php if(($psun != 0)): ?><h5 style='margin-left:50px;'>新用户数量:<span style='color: red;'></span><?php echo ($psun); ?>人</h5>
                            <h5 style='margin-left:50px;'>新用户金额:<span style='color: red;'></span><?php echo ($pmoney); ?>元</h5>
                            <?php else: endif; ?>
                            <a href="<?php echo U('Home/already/otain');?>" style="float: right;"><button>逾期汇报</button></a>
                            <a href="look" style="float: right;"><button>卡升级</button></a>
                            <a style="float:right;" href="<?php echo U('Home/already/export');?>"><button>导出</button></a>
                        </div>
                        <div class="ibox-title">
                            <form action="<?php echo U('Home/Already/search');?>" method="post" style="float: left; margin-right: 0px;">
                                <input type="text" name="name" placeholder="请输入手机号或姓名">
                                <input type="hidden" name="code" value="search">
                                <input type="submit" value="提交">
                            </form>

                            <form action="<?php echo U('Home/Already/expire');?>" method="post" style="float: left; margin-right:0px;" >
                             ...
                             <form action="<?php echo U('Home/Already/search');?>" method="post" style="float: right; margin-right:0px;" >
                                <input placeholder="开始时间" required type="text" id="layui-laydate-input" onclick="layui.laydate({elem: this})" class="layui-input" name="start">
                                <input placeholder="结束时间" required type="text" id="layui-laydate-input" onclick="layui.laydate({elem: this})" class="layui-input" name="end">
                            ...
                            <form action="<?php echo U('Home/Already/statistical');?>" method="post" style="float: left; margin-right:0px;" >
                                <input placeholder="开始时间" required type="text" id="layui-laydate-input" onclick="layui.laydate({elem: this})" class="layui-input" name="start">
                                <input placeholder="结束时间" required type="text" id="layui-laydate-input" onclick="layui.laydate({elem: this})" class="layui-input" name="end">
                            ...
                            <div class="ibox-title"> 
                                <a href="/free/index.php/Home/Already/cuts_interest"><button>查看降息</button></a>
                            </div> 
                        <div class="ibox-content">
                            ...
                            <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="8">
                                ...
                                <?php if(is_array($loan_data)): foreach($loan_data as $k=>$v): ?><tr>
                                    ...
                                    <td>
                                        <a href="<?php echo U('Home/Already/zfb_pay',array('id'=>$v['loan_id']));?>"><button>还款</button></a> 
                                    </td>
                                    <td><a href="<?php echo U('Home/Already/stages',array('order'=>$v['loan_order']));?>"><button>分期</button></a></td>
