        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>续期还款</h5>
                  <!--<a href="<?php echo U('Home/Examine/export');?>">  <button type="button" class="btn btn-primary btn-sm" style="float:right" >导出</button></a>-->
                </div>
                <div class="ibox-content">
                    ...
                    <table id="mytable" class="footable table table-stripped toggle-arrow-tiny" data-page-size="8">
                        ...
                        <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td>
                                        <!-- 申请续期的天数 -->
                                       <?php if(($vo['renewal_days'] == 7) && ($vo['loan_time'] == 1)): echo (res1($vo['pay_time'])); ?>
                                        <?php elseif(($vo['renewal_days'] == 14) && ($vo['loan_time'] == 2)): ?>
                                            <?php echo (res2($vo['pay_time'])); ?>
                                        <?php elseif(($vo['renewal_days'] == 7) && ($vo['loan_time'] == 2)): ?>
                                            <?php echo (res3($vo['pay_time'])); endif; ?> 
                                    </td>
                                    <td><?php echo ($vo['renewal_days']); ?>天</td>
