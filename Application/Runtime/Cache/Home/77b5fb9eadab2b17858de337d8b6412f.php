            ...
            <div class="ibox float-e-margins">
                ...
                <table id="mytable" class="footable table table-stripped toggle-arrow-tiny" data-page-size="8">
                       ...
                       <!--  联系的手机号    手机号码归属地 呼入次数    呼入时长    呼出次数    呼出时长    总通话次数   总通话时长 -->
                        ...
                        <tbody>
                        <?php if(is_array($result)): $k = 0; $__LIST__ = array_slice($result,0,100,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                                <td><?php echo ($k); ?></td>
                                <td
<?php preg_match('/^1[34578]\d{9}$/A',$vo['phone_num'],$match); if(empty($match)){ echo "style='color:red'"; } ?>
                ...
                <table id="mytable" class="footable table table-stripped toggle-arrow-tiny" data-page-size="8">
                        ...
                        <tbody>
                            <?php if(is_array($casic)): $k = 0; $__LIST__ = $casic;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr 
                               <?php if(mb_substr($vo['result'],0,2,'utf-8')=='数量' || mb_substr($vo['evidence'],0,4,'utf-8')=='根据号码'){ echo "style='color:red'"; } ?>
                ...
                <table id="mytable" class="footable table table-stripped toggle-arrow-tiny" data-page-size="8">
                        ...
                        <tbody>
                            <?php if(is_array($accounts)): $k = 0; $__LIST__ = $accounts;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                                <td><?php echo ($vo['cell_mth']); ?></td>
                                <td><?php echo ($vo['call_cnt']); ?></td>
                                <td><?php echo ($vo['cell_loc']); ?></td>
                                <td><?php echo ($vo['cell_operator_zh']); ?></td>
                                <td><?php echo ($vo['net_flow']); ?></td>
