            ...
            <div class="row content-tabs">
               ...
               <div class="col-sm-12">
                    <div class="ibox float-e-margins">
                        <form action="/free/index.php/Home/Already/repayment" method="post" enctype="multipart/form-data" onSubmit="return login();" id="loginForm">
                            <input type="hidden" value="<?php echo ($num); ?>" name="id">
                            输入支付宝订单号：<input type="text" name="order" id="order">
                            <br/>
