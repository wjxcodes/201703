               ...
               <div class="col-sm-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>已注册用户共:<span style="color: red"><?php echo ($count); ?></span>条</h5>
                        </div>
                        <div class="ibox-title">  
                             <form action="<?php echo U('Home/Register/index');?>" method="post" style="float: left; margin-right: 60px;"> 
                            ...
                            <form action="<?php echo U('Home/Register/count');?>" method="post" style="float: left; margin-right: 60px;" >
                                <input placeholder="开始时间" required type="text" id="layui-laydate-input" onclick="layui.laydate({elem: this})" class="layui-input" name="start">
                                <input placeholder="结束时间" required type="text" id="layui-laydate-input" onclick="layui.laydate({elem: this})" class="layui-input" name="end">
                                <input type="hidden" name="code" value="1">
                                <input type="submit"  value="流量检索">
                            </form> 
                            </div>
                            ...
                            <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="8">
                                ...
                                <tbody>
                                    <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                          <td>  <?php if($vo['open_id'] == '' ): echo ($vo['user_name']); ?>
                                            <?php else: ?>
                                            <a href="/free/index.php/Home/amuser/user?open_id=<?php echo ($vo['open_id']); ?>"><?php echo ($vo['user_name']); ?></a><?php endif; ?></td>
