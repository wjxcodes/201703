                ...
                <div class="ibox-content">
                    ...
                    <table id="mytable" class="footable table table-stripped toggle-arrow-tiny" data-page-size="8">
                        ...
                        <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                                    ...
                                    <td>
                                        <?php if(($vo['loan_time'] == 1)): echo (original1($vo['is_pay'])); ?>
                                        <?php elseif(($vo['loan_time'] == 2)): ?>
                                            <?php echo (original2($vo['is_pay'])); endif; ?>
                                    </td>
                                    <td><?php echo (date( "Y-m-d H:i",$vo['repayment_time'])); ?></td>
                                    <td>
                                        <!-- 申请续期的天数 -->
                                       <?php if(($vo['renewal_days'] == 7) && ($vo['loan_time'] == 1)): echo (res1($vo['is_pay'])); ?>
                                        <?php elseif(($vo['renewal_days'] == 14) && ($vo['loan_time'] == 2)): ?>
                                            <?php echo (res2($vo['is_pay'])); ?>
                                        <?php elseif(($vo['renewal_days'] == 7) && ($vo['loan_time'] == 2)): ?>
                                            <?php echo (res3($vo['is_pay'])); endif; ?>  
                                    </td>
