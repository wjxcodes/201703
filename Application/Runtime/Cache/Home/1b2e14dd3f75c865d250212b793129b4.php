            ...
            <div class="row content-tabs">
               ...
               <div class="col-sm-12">
                    ...
                    <div class="ibox-title">
                        <a style="margin-left:10%;" href="<?php echo U('Home/Withhold/debit');?>"><button>执行代扣</button></a>
                    </div>
                        <div class="ibox-content">
                            <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="8">
                                ...
                                <tbody>
                                <?php if(is_array($loan_info)): foreach($loan_info as $k=>$v): ?><tr>
                                    <td><?php echo ($k+1); ?></td>
                                    ...
                                    <td>
                                    <?php if(($v['renewal_days'] != 0)): echo (stopTime($v['user_name'])); ?>
                                    <?php else: ?>
                                    <?php echo (date("Y-m-d H:i",$v['overday_time'])); endif; ?>
                                    </td>
                                    <td>
                                    ...
                                    <td><?php echo ($v['repayment_no']); ?></td>
                                    <td><?php echo ($v['loan_num']); ?></td>
                                    <td><?php echo ($v['ll_code']); ?></td>
                                    <td><?php echo ($v['auth_time']); ?></td>
                                    <td><?php echo ($v['ll_status']); ?></td>
