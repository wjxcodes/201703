            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <table id="mytable" class="footable table table-stripped toggle-arrow-tiny" data-page-size="8">
                        ...
                        <tbody>
                        <?php if(is_array($continued_data)): $k = 0; $__LIST__ = $continued_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                                    <td><?php echo ($k); ?></td>
                                    ...
                                    <td <?php if($vo['repayment_time'] > $time): ?>style="color:red;"<?php endif; ?>><?php echo (date( "Y-m-d H:i",$vo['repayment_time'])); ?></td>
                                   
                                    <td>
                                        <?php if(($vo['loan_time'] == 1)): echo (original1($vo['pay_time'])); ?>
                                        <?php elseif(($vo['loan_time'] == 2)): ?>
                                            <?php echo (original2($vo['pay_time'])); endif; ?>
                                    </td>
                                    <td><?php echo ($vo['loan_amount']); ?></td>
                                    <td>
                                        <?php if($vo['loan_time'] == 2): ?>14
                                        <?php else: ?>
                                            7<?php endif; ?>
                                    </td>
                                    <td><?php echo (date( "Y-m-d H:i",$vo['renewal_days']*86400+$vo['loan_time']*7*86400+$vo['pay_time'])); ?>
                                    </td>
                                    <td>
                                        <?php if(($vo['renewal_days']%7)==0){ echo $vo['renewal_days']."天"; }else{ echo "<span style='color:red'>".$vo['renewal_days']."天</span>"; } ?>
                                    </td>
                                    <td><?php echo ($vo['renewal_num']); ?>次</td>
                                    <td><?php echo ($vo['pay_money']); ?>元</td>
                                    <td><?php echo ($vo['renewal_order']); ?></td>
