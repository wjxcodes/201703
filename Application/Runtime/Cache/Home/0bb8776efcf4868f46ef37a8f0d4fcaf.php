        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                   <div class="ibox-title" id="sumtext">
                        <h5>今天回款:<span style='color:red'><?php echo ($count_num); ?></span>人</h5>
                    </div>
                <div class="ibox-content">
                    <table id="mytable" class="footable table table-stripped toggle-arrow-tiny" data-page-size="8">
                        ...
                        <tbody>
                            <?php if(is_array($loan_data)): $k = 0; $__LIST__ = $loan_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k; if(($vo['lev'] == 1)): ?><tr style="background:#FF4040;color:#080808;">
                                <?php elseif(($vo['lev'] == 2)): ?>
                                    <tr style="background:#FFB90F;color:#080808;">
                                <?php elseif(($vo['lev'] == 3)): ?>
                                    <tr style="background:#7CCD7C;color:#080808;"><?php endif; ?>
                                    <td><?php echo ($k); ?></td>
                                    <td>
                                        <a href="<?php echo U('Home/Bad/info',array('user_name'=>$vo['user_name']));?>"><?php echo ($vo['user_name']); ?></a>
                                    </td>
                                    <td>
                                        <a href="<?php echo U('Home/Bad/beizhu',array('user_name'=>$vo['user_name']));?>"><?php echo ($vo['u_name']); ?></a>
                                    </td>
                                    <td><?php echo ($vo['pay_time']); ?></td>
                                    <td><?php echo ($vo['loan_amount']); ?>元</td>
                                    <td><?php echo (date("Y-m-d H:i",$vo['bentime'])); ?></td>
                                    <td><?php echo ($vo['money']); ?>元</td>
                                    <td><?php echo ($vo['overday']); ?>天</td>
                                    <td><?php echo ($vo['overmoney']); ?>元</td>
                                    <td><?php echo ($vo['sunmoney']); ?>元</td>
                                    <td><?php echo ($vo['link_name']); ?></td>
                                    <td><?php echo ($vo['link_tel']); ?></td>
                                    <td><?php echo ($vo['create']); ?></td>
                                    <td>
                                        <?php if(($v['group'] != 0)): ?><a href="<?php echo U('Home/Bad/recolor',array('no'=>$vo['user_name'],'code'=>1));?>"><button style="color:red">A</button></a>
                                            <a href="<?php echo U('Home/Bad/recolor',array('no'=>$vo['user_name'],'code'=>2));?>"><button style="color:yellow">B</button></a>
                                            <a href="<?php echo U('Home/Bad/recolor',array('no'=>$vo['user_name'],'code'=>3));?>"><button style="color:blue">C</button></a>
                                        <?php else: ?>
