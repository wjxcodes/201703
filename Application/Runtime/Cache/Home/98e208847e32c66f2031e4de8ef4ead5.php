            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content" style="height:1000px">
                    <div style="margin:auto;margin-top:300px;width:50%;">
                        <form class="form-horizontal m-t" id="commentForm" action="<?php echo U('Home/Search/detail');?>" method="post">
                            <input type="text" class="form-control" name="search"  style="float:left;width:90%;" required="" placeholder="输入姓名、手机号、身份证号">
                            <input type="submit" value="搜索" style="float:left;width:10%;" class="btn btn-default">
                        </form>
                    </div>
                </div>
            </div>
