               ...
               <div class="col-sm-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>通过连连还款:<span style="color: red"><?php echo ($count); ?></span>笔</h5>
                        ...
                        <div class="ibox-title">  
                            <form action="<?php echo U('Home/repayment/ll_search',array('id'=>'2'));?>" method="post" style="float: left; margin-right: 60px;" >
                            ...
                            <form action="<?php echo U('Home/repayment/ll_search1',array('id'=>'2'));?>" method="post" style="float: left; margin-right: 60px;" >
                                <input placeholder="开始时间" required type="text" id="layui-laydate-input" onclick="layui.laydate({elem: this})" class="layui-input" name="start1">
                                <input placeholder="结束时间" required type="text" id="layui-laydate-input" onclick="layui.laydate({elem: this})" class="layui-input" name="end1">
                                <input type="hidden" name="code" value="1">
                            ...
                            <a style="float:right; margin-right: 50px;" href="<?php echo U('Home/repayment/remarks');?>"><button>备注</button></a>
                             ...
                             <form action="<?php echo U('Home/repayment/searchs',array('id'=>'2'));?>" method="post" style="float: right; margin-right: 60px;" >
