               ...
               <div class="col-sm-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>未还款:<span style='color: red'></span><?php echo ($sum["ren"]); ?>人</h5>
                            ...
                            <a style="float:right;" href="<?php echo U('Home/already/excel_bepay',array('start_time'=>$start_time,'end_time'=>$end_time));?>"><button>导出</button></a>
                        </div>
                        <div class="ibox-content">
                            <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="8">
                                ...
                                <tbody>
                                <?php if(is_array($loan_data)): $k = 0; $__LIST__ = $loan_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k; if($v['type'] == 1): ?><tr>
                                        ...
                                        <td><a href="<?php echo U('Home/Already/renewal',array('id'=>$v['user_name']));?>"><button>续期</button></a></td>
