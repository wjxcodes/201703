                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            ...
                            <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="8">
                                ...
                                <tbody>
                                    <?php if(is_array($PendingInfo)): $k = 0; $__LIST__ = $PendingInfo;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                                            <td><?php echo ($k); ?></td>
                                           <td><a href="/free/index.php/Home/Examine/credit?id=<?php echo ($vo['user_name']); ?>&open_id=<?php echo ($vo['open_id']); ?>"><?php echo ($vo['user_name']); ?></a></td>
                                            ...
                                            <td><?php echo (banHome($vo['bank_card'])); ?></td>
                                            ...
                                            <td><b><?php echo ($vo['loan_amount']); ?>元</b></td>
                                            <td>
                                                <?php if(($vo['automatic'] == 1)): else: ?>
                                                    <a href="<?php echo U('Home/Pending/change',array('id'=>$vo['loan_id'],'status'=>'1'));?>" onclick="javascript:return del();">确认打款</a><?php endif; ?>
                                            
                                            </td>
                                             <td>
                                             <?php if(($vo['automatic'] == 1)): else: ?>
                                                    <a href="<?php echo U('Home/Pending/changes',array('id'=>$vo['loan_id']));?>" onclick="javascript:return del();">取消打款</a><?php endif; ?>
