        ...
        <div class="col-sm-12">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>已过容时期列表</h5>
                     <h5 style="margin-left:50px;">共计:<span style="color: red"><?php echo ($sum); ?></span>人</h5>
                     <h5 style="margin-left:50px;">逾期本金合计:<span style="color: red"><?php echo ($money_sum); ?></span>元</h5>
                     <h5 style="margin-left:50px;">逾期利息合计:<span style="color: red"><?php echo ($heji_money); ?></span>元</h5>
                     <h5 style="margin-left:50px;">逾期费用合计:<span style="color: red"><?php echo ($overdue_sum_money); ?></span>元</h5>
                </div>
                <div class="ibox-title">
                    <form action="<?php echo U('Home/Overdue/index');?>" method="post" style="float: left;">
                    ...
                    <a style="margin-right:10px; margin-left: 20px;" href="<?php echo U('Home/Pre/note_template',array('code'=>'3'));?>"><button>逾期4-6天本人短信模板</button></a>
                    <a style="margin-right:10px;" href="<?php echo U('Home/Pre/note_template',array('code'=>'4'));?>"><button>逾期5-7天紧急联系人短信模板</button></a>
                    <a style="margin-right:10px;" href="<?php echo U('Home/Pre/note_template',array('code'=>'5'));?>"><button>逾期7天短信模板</button></a>
                    <a style="margin-right:10px;" href="<?php echo U('Home/Pre/note_template',array('code'=>'6'));?>"><button>逾期9天短信模板</button></a>
                    <a style="margin-right:10px;" href="<?php echo U('Home/Pre/note_template',array('code'=>'7'));?>"><button>逾期10天短信模板</button></a>
                    <a style="margin-right:10px;" style="float:right;" href="<?php echo U('Home/Overdue/export_pre');?>"><button>导出</button></a>
                </div>
                <div class="ibox-content">
                    <table id="mytable" class="footable table table-stripped toggle-arrow-tiny" data-page-size="8">
                        ...
                        <?php if(is_array($arr)): $k = 0; $__LIST__ = $arr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr>
                                        ...
                                        <td><?php echo ($vo["linkman_name"]); ?></td>
                                        <td><?php echo ($vo["linkman_tel"]); ?></td>
                                        <td>
